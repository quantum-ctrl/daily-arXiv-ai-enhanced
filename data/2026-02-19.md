...
### [1] [A fully differentiable framework for training proxy Exchange Correlation Functionals for periodic systems](https://arxiv.org/abs/2602.15923)
...
### [2] [Stochastic Modeling of Anisotropic Strength Surfaces from Atomistic Simulations](https://arxiv.org/abs/2602.16007)
...
### [3] [Twist-induced Out-of-plane Ferroelectricity in Bilayer Hafnia](https://arxiv.org/abs/2602.16051)
...
### [4] [Ligand Mediated Magnetoelectronic Coupling Across Metamagnetic Transitions in CrPS4](https://arxiv.org/abs/2602.16083)
...
### [5] [Generative Inverse Estimation of 3D Atomic Coordination from Near-Edge Spectra via Equivariant Diffusion Models](https://arxiv.org/abs/2602.16133)
...
### [6] [Dislocation-ledge coupling drives non-conservative migration of semicoherent precipitate interfaces](https://arxiv.org/abs/2602.16158)
...
### [7] [Negative Strain-Rate Sensitivity in Metallic Glasses Driven by Rejuvenation-Relaxation Competition: Kinetic Monte Carlo Simulations and a Minimal Effective Model](https://arxiv.org/abs/2602.16175)
...
### [8] [Unveiling and quantifying the topology-dependent pre-melting of nanoparticles](https://arxiv.org/abs/2602.16250)
...
### [9] [AI-Driven Structure Refinement of X-ray Diffraction](https://arxiv.org/abs/2602.16372)
...
### [10] [Hidden universality in dislocation-loops mediated three-dimensional crystal melting](https://arxiv.org/abs/2602.16390)
...
### [11] [When Is Structural Lubricity Load Independent? The Role of Contact Geometry and Elastic Compliance](https://arxiv.org/abs/2602.16474)
*Hongyu Gao*
...
### [12] [Thermal Decoherence and Population Transfer of MeV Channeling Electrons in Diamond](https://arxiv.org/abs/2602.16529)
*Tadas Paulauskas*
...
### [13] [The rise and fall of an oxide: insights into the phase diagram of bismuth oxide on Au(111)](https://arxiv.org/abs/2602.16552)
...
### [14] [Addressing Ill-conditioning in Density Functional Theory for Reliable Machine Learning](https://arxiv.org/abs/2602.16618)
...
### [15] [Stoichiometry Dependent Properties of Cerium Hydride: An Active Learning Developed Interatomic Potential Study](https://arxiv.org/abs/2602.16628)
...
### [16] [Universal Framework for Decomposing Ionic Transport into Interpretable Mechanisms](https://arxiv.org/abs/2602.16636)
...
### [17] [Growth and crystallographic structure of TiTe$_2$ on Au(111): From sub-monolayer structures to single- and multi-layer films](https://arxiv.org/abs/2602.16647)
...
### [18] [Current Induced Switching of Superconducting Order and Enhancement of Superconducting Diode Efficiency](https://arxiv.org/abs/2602.16648)
...
### [19] [$p$-wave magnet driven field-free Josephson diode effect](https://arxiv.org/abs/2602.16677)
...
### [20] [Uniaxial stress enhanced anisotropic magnetoresistance and superconductivity in the kagome superconductor LaRu$_{3}$Si$_{2}$](https://arxiv.org/abs/2602.15998)
...
### [21] [Stack of correlated insulating states in bilayer graphene kagome superlattice](https://arxiv.org/abs/2602.16210)
