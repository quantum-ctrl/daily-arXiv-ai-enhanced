...
### [5] [AutoDFT: A Closed-Loop Multi-Agent Framework for Autonomous DFT Calculations](https://arxiv.org/abs/2605.26179)
...
### [6] [Diamond compound refractive lenses for high energy Dark Field X-ray Microscopy](https://arxiv.org/abs/2605.26251)
...
### [7] [Resilience of the physicochemical properties of graphene-based materials for applications in harsh radiation environments](https://arxiv.org/abs/2605.26311)
...
### [8] [Finite Temperature Stacking Fault Stability in Random and Locally Ordered CoCrNi beyond the Harmonic Approximation](https://arxiv.org/abs/2605.26364)
...
### [9] [Direct Dispersion-Curve Engineering of Phononic Crystal Defect Modes for Prescribed Frequencies via Topology Optimization](https://arxiv.org/abs/2605.26435)
...
### [10] [Structural Alter-Phononics: Sublattice-Momentum Locking in Spinless Lattice Dynamics](https://arxiv.org/abs/2605.26453)
...
### [11] [Modulation of charge density waves in a twisted vortex moire superlattice](https://arxiv.org/abs/2605.26510)
...
### [12] [Conditions for domain-free negative capacitance](https://arxiv.org/abs/2605.26536)
...
### [13] [Near-Infrared-Triggered Photodynamic Antibacterial Therapy Using Rose Bengal-Coated Upconverting Nanoparticles](https://arxiv.org/abs/2605.26557)
...
### [14] [Visualizing Degradation in Anode-Free High-Utilization Aqueous Batteries Across Cell Lifetime](https://arxiv.org/abs/2605.26727)
...
### [15] [MatFormBench: A Benchmarking Evaluation Framework for Target-Driven Materials Formulation](https://arxiv.org/abs/2605.26741)
...
### [16] [Tunable competing optical excitation pathways in the topological surface states of Bi$_2$Te$_3$](https://arxiv.org/abs/2605.26799)
...
### [17] [Defect engineering of ultrathin gallium nitride via electric fields for advanced electronic, magnetic, and gas sensing applications](https://arxiv.org/abs/2605.26817)
...
### [18] [Amorphous vs. Short-Range-Ordered Complexions: Consequences for Grain-Boundary-Mediated Plasticity in Nanocrystalline Al-Ni Alloys](https://arxiv.org/abs/2605.27218)
...
### [19] [Radiative electronic bound states in the continuum from defects in semiconductors](https://arxiv.org/abs/2605.26841)
...
### [20] [Electronic properties governing the phase stability and elastic anisotropy of C14 and C15 Cr-Hf-Nb Laves phases](https://arxiv.org/abs/2605.26868)
...
### [21] [Ultrafast signatures of Dirac / flat-band hybrid states from time-resolved ARPES](https://arxiv.org/abs/2605.26873)
...
### [22] [Active learning of collinear magnetic Moment Tensor Potentials using the spin-MLIP package from soft-constrained spin-polarized DFT calculations: a case study of Fe-Pd](https://arxiv.org/abs/2605.26897)
...
### [23] [Temperature dependence of the magnon-phonon coupling in yttrium iron garnet/gadolinium gallium garnet high overtone bulk acoustic resonators](https://arxiv.org/abs/2605.26997)
...
### [24] [Individual Characterization of Fast-Responding Trap States at the NO-Annealed SiO$_2$/4H-SiC Interface](https://arxiv.org/abs/2605.27041)
...
### [25] [Molecular Dynamics Study of Defect Evolution Mechanisms in 3C-SiC for Quantum Technologies](https://arxiv.org/abs/2605.27060)
...
### [26] [Electron Polaron at Neutral 180$^\circ$ Domain Wall in PbTiO$_3$: Stability, Trapping Energies, and Transverse Polarization](https://arxiv.org/abs/2605.27077)
...
### [27] [Origin of the Temperature-Induced Gap Bowing of Formamidinium-Methylammonium Lead Iodide Perovskites: Role of Cationic Rattlers](https://arxiv.org/abs/2605.27104)
...
### [28] [Light-induced Faraday effect from dynamical breakdown of Kleinman symmetry](https://arxiv.org/abs/2605.27127)
...
### [29] [Identifying and designing altermagnetic crystals in real space](https://arxiv.org/abs/2605.27151)
...
### [30] [Rapid estimation of synthesizability windows of inorganic materials from first principles](https://arxiv.org/abs/2605.27162)
...
### [31] [At-Scale Data-Driven Exploration of High-Voltage Cathode-Active Materials for Sodium Batteries](https://arxiv.org/abs/2605.27229)
...
### [32] [Atomically precise mechanosynthesis of carbon structures on hydrogenated Si(100) by inverted-mode STM](https://arxiv.org/abs/2605.27250)
...
### [33] [Microstructure-Aware Deep Learning Bridges Atomistics to Macroscale for Shock-to-Detonation Prediction](https://arxiv.org/abs/2605.27325)
...
### [34] [Locally resolved electronic textures of reconstruction domains in marginally twisted monolayer-bilayer graphene](https://arxiv.org/abs/2605.26393)
...
### [35] [Anharmonic Quantum Transport Analysis of Thermal Transport Anomalies in Ultrathin Silicon Nanowires](https://arxiv.org/abs/2605.26529)
...
### [36] [Geometric Protection of Bipartite Entanglement in Hopf-Linked Quantum Rings](https://arxiv.org/abs/2605.26622)
...
### [37] [Terahertz spin-current transparency through rough interfaces](https://arxiv.org/abs/2605.26837)
...
### [38] [Orbital Magnetization from Uniform and Periodic Magnetic Fields](https://arxiv.org/abs/2605.26889)
*Chunli Huang*
...
### [39] [Anomaly-Induced Hybrid Bulk Electromagnetic Mode in Weyl Semimetals](https://arxiv.org/abs/2605.27031)
...
### [40] [Quantum Geometric Origin of Hall Viscosity and Nonlocal Hall Conductivity in Lattice Bands](https://arxiv.org/abs/2605.27059)
...
### [41] [Microwave-driven Floquet-Fano interference in a ring-chord quantum dot structure for enhanced spin-caloritronic performance](https://arxiv.org/abs/2605.27181)
...
### [42] [Overcoming contact resistance at metal-2D semiconductor interfaces: atomically clean MoS2/Au ohmic junctions](https://arxiv.org/abs/2605.27187)
...
### [43] [Orbital and Spin-Orbit Torque Interplay in Ta/W-based Magnetic Tunnel Junctions with Vertical Non-local Switching](https://arxiv.org/abs/2605.27215)
...
### [44] [High-mobility inertial domain walls driven by spin-transfer torque in a ferrimagnetic spinel oxide](https://arxiv.org/abs/2605.27216)
...
### [45] [Three Quantum-Geometric Contributions to Cubic Orbital Magnetization](https://arxiv.org/abs/2605.27277)
*T. Farajollahpour*
...
### [46] [Absence of a Superradiant Phase Transition in Dirac Landau Polaritons](https://arxiv.org/abs/2605.27319)
