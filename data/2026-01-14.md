...
### [6] [Pressure-Induced Martensitic Phase Transformation and Microstructure Evolution in nanograined $\text{Fe}\text{-}7\%\text{Mn}$ Alloy](https://arxiv.org/abs/2601.08202)
...
### [7] [Effect of Interatomic Potential Choice on Fracture Modes of Graphene with Parallel Cracks](https://arxiv.org/abs/2601.08346)
...
### [10] [Fractional-Monolayer 2D-GaN/AlN Structures: Growth Kinetics and UVC-emitter Applications](https://arxiv.org/abs/2601.08410)
...
### [11] [Cyclic- and helical-symmetry-adapted phonon formalism within density functional perturbation theory](https://arxiv.org/abs/2601.08745)
...
### [12] [Nodal Superconductivity of UTe$_2$ Probed by Field-Angle-Resolved Specific Heat on a Crystal with $T_{\rm c}=2.1$ K](https://arxiv.org/abs/2601.08201)
...
### [13] [Kinetic Blockade and Filamentary Pair Density Waves in Strain-Engineered Graphene](https://arxiv.org/abs/2601.08586)
*Tao Zhou*
...
### [14] [Coupling of Klein-Andreev Resonant States in Bi$_2$Sr$_2$CaCu$_2$O$_{8+x}$-graphene-Bi$_2$Sr$_2$CaCu$_2$O$_{8+x}$ Devices](https://arxiv.org/abs/2601.08637)
...
### [15] [Chiral Two-Body Bound States from Berry Curvature and Chiral Superconductivity](https://arxiv.org/abs/2601.08055)
...
### [16] [Multi-level charge fluctuations in a Si/SiGe double quantum dot device](https://arxiv.org/abs/2601.08088)
...
### [17] [Nodal-line-enhanced quantum geometric effects: anomalous and nonlinear Hall effects in the parity-mixed antiferromagnet NbMnP](https://arxiv.org/abs/2601.08317)
...
### [18] [Magnetization reversal mechanism of double-helix nanowires probed by dark-field magneto-optical Kerr effect](https://arxiv.org/abs/2601.08613)
...
### [19] [Dynamical stability by spin transfer in nearly isotropic magnets](https://arxiv.org/abs/2601.08738)
...
### [20] [Local Magnetometry from Measurement-Induced Dissipation](https://arxiv.org/abs/2601.08762)
...
### [21] [Universal Transport Theory for Paired Fractional Quantum Hall States in the Quantum Point Contact Geometry](https://arxiv.org/abs/2601.08792)
...
### [22] [Forbidden second harmonics in centrosymmetric bilayer crystals](https://arxiv.org/abs/2601.08830)
