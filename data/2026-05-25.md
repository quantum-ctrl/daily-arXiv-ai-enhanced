...
### [4] [Non-reciprocal Coulomb drag in a ballistic quantum wire](https://arxiv.org/abs/2605.22945)
...
### [6] [Optical Transmission of 2D Material with Quantum Anomalous Hall Effect](https://arxiv.org/abs/2605.23211)
...
### [7] [Selective Fermi-Level Pinning: A Design Strategy for Giant Rectification in Molecular Junctions](https://arxiv.org/abs/2605.23370)
...
### [8] [Localized Excitonic Emission in Wafer-Scale MOCVD-Grown GaSe 2D Nanosheets for Classical and Non-Classical Light Sources](https://arxiv.org/abs/2605.23418)
...
### [9] [Generalized Shift Vector as the Intrinsic Dipole of Many-Body Correlated Electronic States](https://arxiv.org/abs/2605.23431)
...
### [10] [Commensuration torques in double-moiré twisted trilayer hexagonal boron nitride and graphene heterostructures](https://arxiv.org/abs/2605.23492)
...
### [11] [Momentum-Resolved Tunneling Modulation Induced Giant Multistate Resistance in Antiferroelectric Multiferroic Junction](https://arxiv.org/abs/2605.23577)
...
### [12] [Graphene-based Photodetector with Engineered Hot Carrier Cooling Dynamics](https://arxiv.org/abs/2605.23646)
...
### [13] [Nonreciprocal conductance in uniformly dissipative devices](https://arxiv.org/abs/2605.23725)
...
### [14] [Orbital Selective Dirac-like States in EuAgAs Revealed by Polarization Dependent ARPES and DFT](https://arxiv.org/abs/2605.23836)
...
### [15] [Effects of compocasting process parameters on microstructural characteristics and tensile properties of A356-SiCp composites](https://arxiv.org/abs/2605.22881)
...
### [16] [Genome-Guided Interpretable Screening of Phase-Stable, Lead-Free Double Perovskite Absorbers for All-Inorganic Semiconductors, Sensors, and Photovoltaics with DFT-Validated Design Rules](https://arxiv.org/abs/2605.22887)
...
### [17] [Thickness-Dependent Spintronic Terahertz Emission in MBE-Grown PtTe$_2$: From Semiconductor to Type-II Dirac Semimetal](https://arxiv.org/abs/2605.22932)
...
### [22] [Thermodynamic stability of twisted domains in AgCrSe$_{2}$ thin films grown on lattice-matched YSZ(111) substrate](https://arxiv.org/abs/2605.23313)
...
### [24] [Studying Creep-Fatigue interaction of Nickel-Based Superalloys using Crystal Plasticity and Entropy-Based life prediction model](https://arxiv.org/abs/2605.23342)
...
### [25] [A Metadynamics-Based Framework for Free Energy Surface Mapping of Multiparticle Diffusion in Crystals](https://arxiv.org/abs/2605.23360)
...
### [26] [Symmetry-protected nodal planes and accidental nodal surfaces in mixed odd-even wave spin-momentum locking of relativistic altermagnets](https://arxiv.org/abs/2605.23438)
...
### [27] [Intrinsic Point Defects and Frenkel Pair Formation in Photovoltaic Absorber Zn$_3$P$_2$: Regulating $p$-type Conductivity through Growth and Annealing Conditions](https://arxiv.org/abs/2605.23479)
...
### [28] [Nonequilibrium dynamics of high energy transitions in monolayer WSe$_{2}$](https://arxiv.org/abs/2605.23480)
...
### [29] [Ambiguity in B-Site cation ordering: A Case study of the double perovskite Ca$_2$CoNbO$_6$](https://arxiv.org/abs/2605.23558)
...
### [30] [First-principles transition-state tensorial cluster expansion of vacancy diffusion in Ta-W beyond the kinetically-resolved activation approximation](https://arxiv.org/abs/2605.23612)
...
### [31] [Close correlation between giant magnetostriction and the microstructure in Fe-Ga melt-spun ribbons](https://arxiv.org/abs/2605.23624)
...
### [32] [Phase-dependent electronic structure of two-dimensional Ag layers at the graphene/SiC interface](https://arxiv.org/abs/2605.23855)
...
### [33] [Photoluminescent Tetragonal Tb-doped Pb2P2O7](https://arxiv.org/abs/2605.23876)
