...
### [1] [AC Response Across the Metal Insulator Transition of YBCO Josephson Junctions Fabricated with a Helium Ion Beam](https://arxiv.org/abs/2601.19235)
...
### [2] [Paramagnetically driven superconducting re-entrance in Eu-doped infinite layer nickelates](https://arxiv.org/abs/2601.19473)
...
### [3] [Bosonic phases across the superconductor-insulator transitions in an infinite-layer samarium nickelate](https://arxiv.org/abs/2601.19497)
...
### [4] [Nonrelativistic-Ising superconductivity in p-wave magnets](https://arxiv.org/abs/2601.19829)
...
### [5] [Curve-Fitting to resolve overlapping voltammetric peaks: Model and examples](https://arxiv.org/abs/2601.18808)
...
### [6] [MAD-SURF: a machine learning interatomic potential for molecular adsorption on coinage metal surfaces](https://arxiv.org/abs/2601.18852)
...
### [7] [Toward Tunable Magnetic Dirac Semimetals: Mn Doping of Cd$_3$As$_2$](https://arxiv.org/abs/2601.18989)
...
### [8] [Light-Emitting Diodes with Micrometer-Thick Perovskite Charge Transport Layers](https://arxiv.org/abs/2601.19067)
*Sang-Hyun Chin*
...
### [9] [C2NP: A Benchmark for Learning Scale-Dependent Geometric Invariances in 3D Materials Generation](https://arxiv.org/abs/2601.19076)
...
### [10] [Altermagnetic spin-split Fermi surfaces in CrSb revealed by quantum oscillation measurements](https://arxiv.org/abs/2601.19105)
...
### [11] [Atomic and Electronic Structure of Strongly Charged Domain Walls in van der Waals α-In$_2$Se$_3$](https://arxiv.org/abs/2601.19137)
...
### [12] [Mapping Metastable Magnetic Textures in (Fe0.5Co0.5)5GeTe2 with in-situ Lorentz Transmission Electron Microscopy](https://arxiv.org/abs/2601.19181)
...
### [13] [Site preference of chalcogen atoms in 1T$^\prime$ $MX_{2(1-x)}Y_{2x}$ ($M=$ Mo and W; $X, Y=$ S, Se, and Te)](https://arxiv.org/abs/2601.19219)
...
### [14] [Symmetry Adapted Analysis of Screw Dislocation: Electronic Structure and Carrier Recombination Mechanisms in GaN](https://arxiv.org/abs/2601.19240)
...
### [15] [Mapping optical, chemical, structural features in ZrO2 via cross-sectional SEM-Cathodoluminescence correlation microscopy](https://arxiv.org/abs/2601.19428)
...
### [16] [Charge redistribution at metal-ZrO2 interfaces: A combined DFT and continuum electrostatic study](https://arxiv.org/abs/2601.19436)
...
### [17] [Graphene Nanoribbon-Graphdiyne Lateral Heterojunctions with Atomically Abrupt Interfaces](https://arxiv.org/abs/2601.19437)
...
### [18] [Si-Ga2O3/p-GaN epitaxial heterostructure based self-powered and visible-blind UV photodetectors with fast and electrically tuneable response time](https://arxiv.org/abs/2601.19492)
...
### [19] [Near-field effects on cathodoluminescence outcoupling in perovskite thin films](https://arxiv.org/abs/2601.19534)
...
### [20] [Discrete Dislocation Dynamics Modeling of Nanotwinned Materials: Orientation Effects in a Multilayer Twinned Structure of Copper](https://arxiv.org/abs/2601.19543)
...
### [21] [All-electrical switching of spin texture in a strain-tunable 2D Janus ferroelectric altermagnet](https://arxiv.org/abs/2601.19560)
...
### [22] [Lanthanide-Dependent Clustering in Yb$^{3+}$/Ln$^{3+}$ Co-Doped CaF$_2$ Nanocrystals: Correlating Spectroscopic Signatures with DFT Insights](https://arxiv.org/abs/2601.19566)
...
### [23] [Revealing the (111) surface electronic structure of epitaxially grown Na$_2$KSb photocathode](https://arxiv.org/abs/2601.19652)
...
### [24] [Comparative Analysis of Plasticity-based GND Density Estimation Methods in Crystal Plasticity Finite Element Models](https://arxiv.org/abs/2601.19763)
...
### [25] [Atomic imaging of 2D transition metal dihalides](https://arxiv.org/abs/2601.19796)
...
### [26] [Topological hybridisation of plasmons with ferrimagnetic magnons](https://arxiv.org/abs/2601.18995)
...
### [27] [Transport spin polarization in RuO$_2$ films](https://arxiv.org/abs/2601.19052)
...
### [28] [Fundamental Tests of Quantum Geometric Bounds in Ionic and Covalent Insulators using Inelastic X-Ray Scattering](https://arxiv.org/abs/2601.19054)
...
### [29] [$PT$ Symmetry's Real Topology](https://arxiv.org/abs/2601.19069)
*J. X. Dai,Y. X. Zhao*
...
### [30] [Ultrastrong light-matter coupling in near-field coupled split-ring resonators revealed by photocurrent spectroscopy](https://arxiv.org/abs/2601.19292)
...
### [31] [Molecular Hamiltonian learning from setpoint-dependent scanning tunneling spectroscopy](https://arxiv.org/abs/2601.19371)
...
### [32] [Deterministic non-local parity control and supercurrent-based detection in an Andreev molecule](https://arxiv.org/abs/2601.19373)
...
### [33] [Nonlinear waves: a review Vector $0π$ pulse and the generalized perturbative reduction method](https://arxiv.org/abs/2601.19521)
*G. T. Adamashvili*
...
### [34] [Dual-Switch Control of a Layer-Locked Anomalous Valley Hall Effect in a Sliding Ferroelectric Antiferromagnet](https://arxiv.org/abs/2601.19556)
...
### [35] [Observation of an exciton crystal in a moiré excitonic insulator](https://arxiv.org/abs/2601.19603)
...
### [36] [Microscopic theory of an atomic spin diode](https://arxiv.org/abs/2601.19604)
...
### [37] [Fundamental Relations as the Leading Order in Nonlinear Thermoelectric Responses with Time-Reversal Symmetry](https://arxiv.org/abs/2601.19625)
...
### [38] [Interband State Transfer in Double-Gated Bilayer Graphene at High Electric Field](https://arxiv.org/abs/2601.19869)
