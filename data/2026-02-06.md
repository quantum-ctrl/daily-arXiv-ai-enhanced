...
### [1] [From Literature to Lab: Closed-Loop Advancement of Perovskite Solar Cells via Domain Knowledge Guided LLM](https://arxiv.org/abs/2602.04914)
...
### [2] [Predictive Machine Learning Molecular Dynamics of SEI Formation in Concentrated LiTFSI and LiPF6 Electrolytes for Lithium Metal Batteries](https://arxiv.org/abs/2602.05141)
...
### [3] [Substitutional oxygen as the origin of the 3.5 eV luminescence in hexagonal boron nitride](https://arxiv.org/abs/2602.05253)
*Marek Maciaszek*
...
### [4] [Multi-wavelength Spin Dynamics of Defects in Hexagonal Boron Nitride](https://arxiv.org/abs/2602.05301)
...
### [5] [Quasi-One-Dimensional Electronic Nature of Ta4SiTe4 Underlying the Giant Thermoelectric Performance](https://arxiv.org/abs/2602.05369)
...
### [6] [Physics-informed acquisition weighting for stoichiometry-constrained Bayesian optimization of oxide thin-film growth](https://arxiv.org/abs/2602.05350)
...
### [7] [Ferroelectricity in Atomically Thin Metallic TaNiTe$_5$ with Ultrahigh Carrier Density](https://arxiv.org/abs/2602.05398)
...
### [8] [First-principles study of photovoltaic and thermoelectric properties of AgBiSCl2](https://arxiv.org/abs/2602.05355)
...
### [9] [Platform and Framework for Time-Resolved Nanoscale Thermal Transport Measurements in STEM](https://arxiv.org/abs/2602.05911)
...
### [10] [CatFlow: Co-generation of Slab-Adsorbate Systems via Flow Matching](https://arxiv.org/abs/2602.05372)
...
### [11] [Crystallinity Evolution of MOCVD-Grown $β$-Ga$_2$O$_3$ Films Probed by In Situ HT-XRD under Different Reactor Heights](https://arxiv.org/abs/2602.05481)
...
### [12] [Observation of large perpendicular magnetic anisotropy and excessive polar magneto-optical effect in Pt/CoFeB/Ru tri-layer system](https://arxiv.org/abs/2602.05655)
...
### [13] [Broken neural scaling laws in materials science](https://arxiv.org/abs/2602.05702)
...
### [14] [Questionable van der Waals Epitaxy of Non-Layered Materials on Fluorophlogopite Mica: The Case of ScN](https://arxiv.org/abs/2602.05741)
...
### [15] [AMDAT: An Open-Source Molecular Dynamics Analysis Toolkit for Supercooled Liquids, Glass-Forming Materials, and Complex Fluids](https://arxiv.org/abs/2602.05865)
...
### [16] [Low-temperature spin dynamics in LAFO thin films: from cubic anisotropy to TLS-limited coherence](https://arxiv.org/abs/2602.05889)
...
### [17] [Best practices for a proper evaluation and conversion of physical property equations in superconductors: the examples of WHH formulation, Bean model and other cases of interest](https://arxiv.org/abs/2602.04973)
...
### [18] [Vertical Nb Josephson junctions fabricated by direct metal deposition on both surfaces of freestanding graphene layers](https://arxiv.org/abs/2602.05170)
...
### [19] [Ferron-Polaritons in Superconductor/Ferroelectric/Superconductor Heterostructures](https://arxiv.org/abs/2602.05473)
...
### [20] [Higher-Order Topological Superconductivity and Electrically Tunable Majorana Corner Modes in Monolayer MnXPb$_2$ (X=Se, Te)-Pb Heterostructure](https://arxiv.org/abs/2602.05505)
...
### [21] [Raman response of collective modes in multicomponent superconductors](https://arxiv.org/abs/2602.05607)
...
### [22] [Electronic Structure and Superconducting Gap of HgBa$_2$Ca$_2$Cu$_3$O$_{8+δ}$ Revealed by Laser-Based Angle-Resolved Photoemission Spectroscopy](https://arxiv.org/abs/2602.05624)
...
### [23] [Fit-Free Optical Determination of Electronic Thermalization Time in Nematic Iron-Based Superconductors](https://arxiv.org/abs/2602.05771)
...
### [24] [Minimal Hamiltonian deformations as bulk probes of effective non-Hermiticity in Dirac materials](https://arxiv.org/abs/2602.05040)
...
### [25] [Strong radial electric field scaling near nanoscale conductive filaments and the ReRAM resistive switching mechanism](https://arxiv.org/abs/2602.05067)
...
### [26] [Transport signatures of topological commensurate off-diagonal Aubry-André-Harper chain](https://arxiv.org/abs/2602.05338)
*Arpita Koley*
...
### [27] [Compact self-matched gyrators using edge magnetoplasmons](https://arxiv.org/abs/2602.05439)
...
### [28] [Direct observation of propagating spin waves in a spin-Hall nano-oscillator](https://arxiv.org/abs/2602.05603)
...
### [29] [Color Centers and Hyperbolic Phonon Polaritons in Hexagonal Boron Nitride: A New Platform for Quantum Optics](https://arxiv.org/abs/2602.05736)
...
### [30] [Anomalous thermoelectric and thermal Hall effects in irradiated altermagnets](https://arxiv.org/abs/2602.05745)
