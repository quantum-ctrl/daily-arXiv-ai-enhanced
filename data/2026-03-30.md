...
### [1] [Composition-dependent bulk properties in intercalated transition metal dichalcogenides $Co_{1/3(1\pmδ)}NbS_{2}$](https://arxiv.org/abs/2603.26069)
...
### [2] [A Sc2C2@C88 cluster based ultra-compact multi-level probabilistic bit for matrix multiplication](https://arxiv.org/abs/2603.26198)
...
### [3] [The Unreconstructed α-Al$_{2}$O$_{3}$(0001) Surface is Inhomogeneous and Rough](https://arxiv.org/abs/2603.26201)
...
### [4] [Probing deuterium-induced magnetic phase transitions in TbCo alloys with in-situ polarized neutron reflectometry](https://arxiv.org/abs/2603.26242)
...
### [5] [Emergence of multiple quasi-ferromagnetic magnon modes induced by strong magnetoelastic coupling in $TmFeO_3$ single crystal](https://arxiv.org/abs/2603.26284)
...
### [6] [Ultrafast Formation and Annihilation of Strongly Bound, Anisotropic Excitons](https://arxiv.org/abs/2603.26294)
...
### [7] [Hunting Structural Demons in Digital Reticular Chemistry](https://arxiv.org/abs/2603.26295)
...
### [8] [Refining hydrogen positions in α-FeOOH through combined neutron diffraction and computational techniques](https://arxiv.org/abs/2603.26634)
...
### [9] [Imaging the Meissner effect and local superfluid stiffness in a graphene superconductor](https://arxiv.org/abs/2603.25807)
...
### [10] [Double-peak Majorana bound states in altermagnet--superconductor heterostructures](https://arxiv.org/abs/2603.25844)
...
### [11] [Assessing the classicality of photon echo from excitons in lead halide perovskite nanocrystals](https://arxiv.org/abs/2603.25996)
...
### [12] [On the interpretation of Hahn echo measurements in electron spin resonance scanning tunneling microscopy](https://arxiv.org/abs/2603.26255)
...
### [13] [Gigahertz-clocked Generation of Highly Indistinguishable Photons at C-band Wavelengths](https://arxiv.org/abs/2603.26651)
