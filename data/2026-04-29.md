...
### [2] [Visualizing Crystallization Dynamics and Transformation Pathways of Disordered Rocksalt Oxides During Thermally Activated Sol-Gel Synthesis](https://arxiv.org/abs/2604.24941)
...
### [3] [Influence of Heterogeneity on the Response of Architected Metamaterials](https://arxiv.org/abs/2604.25075)
...
### [4] [Ultrafast Energy Absorption in Silicon Controlled by Two-Color Double Pulses](https://arxiv.org/abs/2604.25093)
...
### [5] [Determination of the Fermi Energy of Diamond using Photoluminescence Spectral Analysis](https://arxiv.org/abs/2604.25097)
...
### [6] [Electric-field control of hydrogen bonding via interfacial charge at atomic resolution](https://arxiv.org/abs/2604.25114)
...
### [7] [Kohn-Sham Hamiltonian from Effective Field Theory: Quasiparticle Band Narrowing from Frozen Core Dynamics](https://arxiv.org/abs/2604.25199)
...
### [9] [Benchmarking Universal Machine-Learned Interatomic Potentials for High-Temperature Metal-Organic Framework Chemistry](https://arxiv.org/abs/2604.25262)
...
### [10] [Reversible Modulation of Thermal Conductivity in GaN via Strain-Driven Reorganization of Dislocation Ensembles](https://arxiv.org/abs/2604.25287)
...
### [11] [Proximity Ferroelectricity Driven by Mobile High-Miller-Index Domain Walls](https://arxiv.org/abs/2604.25343)
...
### [12] [Determination of Burgers vectors of dislocations in monoclinic $β$-Ga$_2$O$_3$ crystals by large-angle convergent-beam electron diffraction](https://arxiv.org/abs/2604.25428)
...
### [13] [From Ultrafast Demagnetization to Ultrafast Spintronics : a 30 years story](https://arxiv.org/abs/2604.25431)
...
### [14] [Thermodynamic surface reconstruction governs catalytic behavior in high-entropy alloys](https://arxiv.org/abs/2604.25454)
...
### [15] [Probing sliding ferroelectricity in bilayer T$_\mathrm{d}$-WTe$_2$ with high-harmonic generation](https://arxiv.org/abs/2604.25483)
...
### [16] [Electronic structures of spin-orbit-coupled metal candidate PbRe$_2$O$_6$: one dimensionality and molecular orbital formation](https://arxiv.org/abs/2604.25539)
...
### [17] [Benchmarking bandgap prediction in semiconductors under experimental and realistic evaluation settings](https://arxiv.org/abs/2604.25568)
...
### [18] [Tuning magnitude and direction of lattice thermal conductivity in transition metal dichalcogenide heterobilayers](https://arxiv.org/abs/2604.25576)
...
### [19] [Substitutional platinum as an efficient nonradiative recombination center in silicon](https://arxiv.org/abs/2604.25621)
...
### [20] [Spin-Axis-Layer Locking for Intrinsic Bipolar Altermagnetic Semiconductors: Proof-of-Concept in Bilayer CuBr2](https://arxiv.org/abs/2604.25658)
...
### [21] [Chemical transformation of MgH2/V2O5 composite to Mg-V-O rock salt and its influence on the electrochemical Li conversion and hydrogen storage characteristics of MgH2](https://arxiv.org/abs/2604.25718)
...
### [22] [Predicting challenging phase transitions with Bayesian active learning](https://arxiv.org/abs/2604.25756)
...
### [23] [Global DIC-based sample-detector geometry refinement for accurate EBSD indexing](https://arxiv.org/abs/2604.25869)
...
### [24] [Structure Prediction and Bonding Analysis of B$_{18}$Ag$_2$ Clusters Featuring Double-Ring Motifs](https://arxiv.org/abs/2604.25908)
...
### [25] [Nonlocal Cooper pairs in finite topological superconductors and their relation to Majorana nonlocality](https://arxiv.org/abs/2604.25169)
...
### [26] [High-field magneto-optical imaging of superconducting critical states beyond 10 T using a paramagnetic garnet sensor](https://arxiv.org/abs/2604.25274)
...
### [27] [Differentiation of electron doping and oxygen reduction in electron-doped cuprates](https://arxiv.org/abs/2604.25450)
...
### [28] [Critical Role of Hydrogen in Unconventional Superconductors: The Case of Hydrogenated FeSe Layers](https://arxiv.org/abs/2604.25500)
...
### [29] [Geometric Rashba Control of Polar Pairing at LaAlO$_3$/KTaO$_3$ Interfaces](https://arxiv.org/abs/2604.25805)
*Yi Zhou*
...
### [30] [Thermodynamic Identification of the Internal Superconducting Phase Boundary in UTe$_2$ for $H \parallel b$](https://arxiv.org/abs/2604.25896)
...
### [31] [Absence of Quasi-Majorana False Positives in Full-Shell Hybrid Nanowires](https://arxiv.org/abs/2604.24858)
...
### [32] [Dispersion of Anyon Bloch Bands](https://arxiv.org/abs/2604.24859)
...
### [33] [Probing Spin Dynamics Across Magnetic Phase Transitions in CrCl3 Nanoflakes Using Nitrogen-Vacancy Microscopy](https://arxiv.org/abs/2604.25002)
...
### [34] [Femtosecond tunneling spectroscopy of ultrafast band bending dynamics at the atomic limit](https://arxiv.org/abs/2604.25146)
...
### [35] [Anomalous Mixed-State Floquet Topology in One-Dimensional Open Quantum Systems](https://arxiv.org/abs/2604.25248)
...
### [36] [Synthetic Polariton Matter in the solid state](https://arxiv.org/abs/2604.25413)
*Sylvain Ravets*
...
### [37] [Temporal hopping dynamics in exciton-polariton condensation](https://arxiv.org/abs/2604.25519)
...
### [38] [Doping-Induced Brightening of Dark Excitons and Trions in a WSe$_2$ Monolayer](https://arxiv.org/abs/2604.25553)
...
### [39] [Magnomechanical Coupling in Suspended 2D van der Waals Ferromagnets](https://arxiv.org/abs/2604.25588)
...
### [40] [Binary topological logic gates in Kane-Mele nanostructures via local control of edge-state transport](https://arxiv.org/abs/2604.25633)
*K. Zberecki*
...
### [41] [Magnetoplasma excitations in interacting GaAs disks](https://arxiv.org/abs/2604.25736)
...
### [42] [Linear response from tilted Dirac cones under strain-induced pseudomagnetic fields](https://arxiv.org/abs/2604.25758)
...
### [43] [3D integration of a hybrid quantum dot circuit-QED device for fast gate dispersive charge readout and coherent spin-photon coupling](https://arxiv.org/abs/2604.25871)
