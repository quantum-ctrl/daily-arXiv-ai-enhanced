...
### [1] [Neural Networks as Physics-Consistent Surrogates: An \textit{Explainable AI} Validation Framework for Learning Constitutive Relations](https://arxiv.org/abs/2512.02064)
...
### [2] [Evaluation of carbon incorporation in sulfide thin films grown by hybrid pulsed laser deposition](https://arxiv.org/abs/2512.02168)
...
### [3] [Coupling between ferroelectric distortions and excitonic properties in PbTiO$_3$](https://arxiv.org/abs/2512.02196)
...
### [4] [End-to-end machine-learned interatomic potentials for modeling functionalized mesoporous aluminosilicates](https://arxiv.org/abs/2512.02309)
...
### [5] [Effective Mass of a Migrating Interface](https://arxiv.org/abs/2512.02372)
...
### [6] [Exploring the Electronic Nature of Spinel Oxides: A Review of Their Electron Interactions and Prospects](https://arxiv.org/abs/2512.02894)
...
### [7] [Coupled plastic strain- and stress-induced phase transformations and microstructure evolution in Fe-7%Mn alloy in dynamic rotational diamond anvil cell](https://arxiv.org/abs/2512.02380)
...
### [8] [Harnessing Multifractality to Enhance Thermal Stability in Mixed-Phase Vanadium Oxide Thin Films](https://arxiv.org/abs/2512.02430)
...
### [9] [Low-temperature thermal conductivity of the substrate material YAlO3 and its unconventional sister compound YbAlO3](https://arxiv.org/abs/2512.02514)
...
### [10] [Framework for Electrochemical & Electrical Energy Storage Materials Database](https://arxiv.org/abs/2512.02585)
...
### [11] [Strengthening and toughening mechanisms in heterostructured laminates revealed by a phase field-enhanced crystal plasticity simulation](https://arxiv.org/abs/2512.02592)
...
### [12] [Accurate Modeling of Gate Leakage Currents in SiC Power MOSFETs](https://arxiv.org/abs/2512.02604)
...
### [13] [Precise Twist Angle Determination in twisted WSe2 via Optical Moiré Phonons](https://arxiv.org/abs/2512.02615)
...
### [14] [Electric-Field and Doping-Induced Non collinear Magnetic Interactions in Monolayer Ti$_2$Si](https://arxiv.org/abs/2512.02638)
...
### [15] [Competing excitonic couplings as origin of mimicked phase transitions in zinc-phthalocyanine single crystals](https://arxiv.org/abs/2512.02639)
...
### [16] [Rational regulation strategies of interstitial localized electrons in electride: A density functional theory study](https://arxiv.org/abs/2512.02674)
...
### [17] [Ultrasensitive Anti-Stokes Luminescence Thermometry in Transition Metal Dichalcogenide Monolayers](https://arxiv.org/abs/2512.02754)
...
### [18] [Realization of polytype heterostructures via delicate structural transitions from a doped-Mott insulator](https://arxiv.org/abs/2512.02778)
...
### [19] [Intervention Strategies for Polarization Switching in Hybrid Improper Ferroelectrics](https://arxiv.org/abs/2512.02916)
...
### [20] [Magnetic field induced polarization enhancement in the photoluminescence of MBE-grown WSe$_2$ layers](https://arxiv.org/abs/2512.02938)
...
### [21] [Representation of Inorganic Synthesis Reactions and Prediction: Graphical Framework and Datasets](https://arxiv.org/abs/2512.02947)
...
### [22] [Altermagnetoelectric Spin Field Effect Transistor](https://arxiv.org/abs/2512.02974)
...
### [23] [New insights into hydrogen-assisted intergranular cracking in nickel](https://arxiv.org/abs/2512.02979)
...
### [24] [Learning interpretable surface elasticity properties from bulk properties](https://arxiv.org/abs/2512.02985)
...
### [25] [Magnetoelectric effect in the mixed valence polyoxovanadate cage V$_{12}$](https://arxiv.org/abs/2512.02215)
*Piotr Kozłowski*
...
### [26] [Chemical potential of magnon polarons](https://arxiv.org/abs/2512.02222)
...
### [27] [Perfect impedance matching unlocks sensitive radio-frequency reflectometry in 2D material quantum dots](https://arxiv.org/abs/2512.02225)
...
### [28] [Anharmonic interaction as random field for thermal transport in FPU-$β$ lattice](https://arxiv.org/abs/2512.02313)
*Li Wan*
...
### [29] [Quantum Coulomb drag signatures of Majorana bound states](https://arxiv.org/abs/2512.02401)
...
### [30] [Su-Schrieffer-Heeger model driven by sequences of two unitaries: periodic, quasiperiodic and random protocols](https://arxiv.org/abs/2512.02470)
...
### [31] [Tuning proximity-induced spin-orbit coupling in graphene/WSe$_{2}$ heterostructures](https://arxiv.org/abs/2512.02522)
...
### [32] [Real-time imaging of slow noisy quasiparticle dynamics at a non-trivial metastable defect in an electronic crystal](https://arxiv.org/abs/2512.02688)
...
### [33] [Emergent Quantum Valley Hall Insulator from Electron Interactions in Transition-Metal Dichalcogenide Heterobilayers](https://arxiv.org/abs/2512.02723)
...
### [34] [Topological Pseudospin Hall Effect and Multi-frequency Corner Modes in Kagome-based Lattices](https://arxiv.org/abs/2512.02762)
...
### [35] [Theory of single-photon emission from neutral and charged excitons in a polarization-selective cavity](https://arxiv.org/abs/2512.02798)
...
### [36] [Positional memory of skyrmions in magnetic bilayers](https://arxiv.org/abs/2512.02877)
...
### [37] [Tunable giant Purcell enhancement of quantum light emitters by means of acoustic graphene plasmons](https://arxiv.org/abs/2512.02907)
...
### [38] [Electrically driven plasmon-polaritonic bistability in Dirac electron tunneling transistors](https://arxiv.org/abs/2512.02909)
...
### [39] [Josephson scanning tunneling spectroscopy in superconducting phases coexisting with pair-, charge- and spin-density-waves](https://arxiv.org/abs/2512.02191)
...
### [40] [Simulation-Based Inference of Ginzburg--Landau Parameters in Type--1.5 Superconductors](https://arxiv.org/abs/2512.02411)
*Jung-Shen Kao*
...
### [41] [Translational symmetry breaking in the electronic nematic phase of BaFe2As2](https://arxiv.org/abs/2512.02488)
...
### [42] [Intrinsic and Tunable Superconducting Diode Effect in Quantum Spin Hall Systems](https://arxiv.org/abs/2512.02575)
...
### [43] [Higgs physics in superconductors](https://arxiv.org/abs/2512.02637)
...
### [44] [Phase-sensitive non-reciprocal transport in high-temperature superconductor](https://arxiv.org/abs/2512.02752)
...
### [45] [Intrinsic Second-Order Topological Superconductors with Tunable Majorana Zero Modes](https://arxiv.org/abs/2512.02775)
