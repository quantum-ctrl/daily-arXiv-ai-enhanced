...
### [1] [Magnetotransport Spectroscopy of Strongly Rashba-Split Hole Subbands Reveals Many-Body Interactions](https://arxiv.org/abs/2602.12440)
...
### [2] [Effects of magnonic Kerr nonlinearity on magnon-polaritons with a soft-mode](https://arxiv.org/abs/2602.12550)
*Takahiro Chiba*
...
### [3] [Photogalvanic Effects in Surface States of Topological Insulators under Perpendicular Magnetic Fields](https://arxiv.org/abs/2602.12553)
...
### [4] [Three-body Fermi-liquid corrections for Andreev transport through quantum dots](https://arxiv.org/abs/2602.12578)
...
### [5] [Topology and edge modes surviving criticality in non-Hermitian Floquet systems](https://arxiv.org/abs/2602.12588)
*Longwen Zhou*
...
### [6] [Gapped out-of-phase plasmon modes in alternating-twist multilayer graphene](https://arxiv.org/abs/2602.12625)
...
### [7] [Magnetoplasmons in $N$-layer structures](https://arxiv.org/abs/2602.12722)
...
### [8] [Presence versus absence of charging energies in PbTe quantum dots](https://arxiv.org/abs/2602.12791)
...
### [9] [Nonparabolic dispersion of charge carriers in CsPbI$_3$ in the orthorhombic phase](https://arxiv.org/abs/2602.12827)
...
### [10] [Subcycle videography of lightwave-driven Landau-Zener-Majorana transitions in graphene](https://arxiv.org/abs/2602.12844)
...
### [11] [Non-renormalization of the Hall viscosity of integer and Jain fractional quantum Hall phases by Coulomb interactions](https://arxiv.org/abs/2602.12915)
*Maik Selch*
...
### [12] [On the effect of Edge vs bulk effects in Graphene Nanoribbons](https://arxiv.org/abs/2602.12944)
...
### [13] [Non-chiral ephemeral edge states and cascading of exceptional points in the non-reciprocal Haldane model](https://arxiv.org/abs/2602.13147)
...
### [14] [Investigating the Electronic and Magnetic Properties of Na$_x$Fe$_{1/2}$Mn$_{1/2}$O$_2$ Cathode Materials with X-ray Compton Scattering](https://arxiv.org/abs/2602.12378)
...
### [15] [Symmetries of Spin-Splitting Induced by Spin-Orbit Coupling in Non-magnetic Crystals](https://arxiv.org/abs/2602.12396)
...
### [16] [A Transformer-based Model for Rapid Microstructure Inference from Four-Dimensional Scanning Transmission Electron Microscopy Data](https://arxiv.org/abs/2602.12420)
...
### [17] [A variational critical-state theory of friction](https://arxiv.org/abs/2602.12427)
...
### [18] [Re-evaluating photoluminescent defects in Cu$_2$O](https://arxiv.org/abs/2602.12466)
...
### [19] [Mechanism-driven CO2 Capture and Activation on Two-dimensional Transition-metal Diborides](https://arxiv.org/abs/2602.12562)
...
### [20] [Strain-enhanced edge ferromagnetism and bipolar magnetic semiconducting behavior in Janus graphene nanoribbons](https://arxiv.org/abs/2602.12582)
...
### [21] [Room-Temperature Terahertz Photoconductivity Polarity Switching in High Entropy Nickelates with Implications for Photonic Synapses](https://arxiv.org/abs/2602.12620)
...
### [22] [Exploring Wetting and Optical Properties of CuAg Alloys via Surface Texture Morphology Analysis](https://arxiv.org/abs/2602.12848)
...
### [23] [The role of radiation-induced segregation in defect-phase formation in Ni-Ge and Ni-Si alloys](https://arxiv.org/abs/2602.12860)
...
### [24] [Dependence of the Mn sticking coefficient on Ga-rich, N-rich, and Ga/N-flux-free conditions in GaN grown by plasma-assisted molecular beam epitaxy](https://arxiv.org/abs/2602.12882)
...
### [25] [Interface-Driven Growth Mode Control of 2D GaSe on 3D GaAs Substrates with Distinct Crystallographic Orientations](https://arxiv.org/abs/2602.12899)
...
### [26] [Molecular Beam Epitaxy of Al$\mathrm{_{1-x}}$Sc$\mathrm{_{x}}$N Nanowires: Towards Group-III Nitride Piezoelectric Nanogenerators with Enhanced Response](https://arxiv.org/abs/2602.12956)
...
### [27] [High-Tc Superconductivity in Functionalized Out-of-Plane Ordered Double Transition Metal MXenes](https://arxiv.org/abs/2602.12960)
...
### [28] [A molecular-spin photovoltaic device](https://arxiv.org/abs/2602.12991)
...
### [29] [Quantitative Photoemission Predictions of Semiconducting Photocathodes from Many-Body Ab Initio Theory](https://arxiv.org/abs/2602.12997)
...
### [30] [Negative thermal expansion in ice I polytypes](https://arxiv.org/abs/2602.13053)
...
### [31] [Mystery of the 175 cm$^{-1}$ Raman Mode in MnTe Altermagnet](https://arxiv.org/abs/2602.13065)
...
### [32] [Physics-Informed Glass-Structure Descriptors for Assessing the Intrinsic Reactivity of Mixed Amorphous-Crystalline Precursors in Alkali-Activated Materials](https://arxiv.org/abs/2602.13101)
...
### [33] [Unveiling the origin of the capacity fade in MnO$_{2}$ zinc-ion battery cathodes through an analysis of the Mn vacancy formation](https://arxiv.org/abs/2602.13116)
...
### [34] [Valence-free open nanoparticle superlattices](https://arxiv.org/abs/2602.13117)
...
### [35] [Diamond-to-graphite transformation under hypersonic impact](https://arxiv.org/abs/2602.13188)
...
### [36] [Disorder viscosity correction approach to calculate spinodal temperature and wavelength](https://arxiv.org/abs/2602.13190)
...
### [37] [Time Reversal Symmetry Breaking and {\it Fragile Magnetic Superconductors}](https://arxiv.org/abs/2602.12514)
*Warren E. Pickett*
...
### [38] [Introduction to High-Temperature Superconductivity for Solid State Chemists](https://arxiv.org/abs/2602.12608)
*Zenji Hiroi*
...
### [39] [Limits of Thermal Conductance Quantization in Chiral Topological Josephson Junctions](https://arxiv.org/abs/2602.12947)
...
### [40] [Quantitative imaging of Abrikosov vortices by scanning quantum magnetometry](https://arxiv.org/abs/2602.13060)
