...
### [1] [Ferroelectric Hysteresis in Superconducting Bilayers](https://arxiv.org/abs/2512.04251)
...
### [2] [Superconductivity onset above 60 K in ambient-pressure nickelate films](https://arxiv.org/abs/2512.04708)
...
### [3] [Demonstration of surface-engineered oxidation-resistant Nb-Nb thermocompression bonding toward scalable superconducting quantum computing architectures](https://arxiv.org/abs/2512.04712)
...
### [4] [Evolution of Correlated Electrons in ${\rm La_3Ni_2O_7}$ at Ambient Pressure: a Study of Double-Counting Effect](https://arxiv.org/abs/2512.04754)
...
### [5] [Interplay between Superconductivity and Altermagnetism in Disordered Materials and Heterostructures](https://arxiv.org/abs/2512.04819)
...
### [6] [Quantum geometry and linear orbital response in arbitrary $SU(2)$ representation](https://arxiv.org/abs/2512.04164)
...
### [7] [Andreev Optoelectronics](https://arxiv.org/abs/2512.04176)
...
### [8] [In-plane anomalous features in the 3D quantum Hall regime](https://arxiv.org/abs/2512.04353)
...
### [9] [Ultrafast transient absorption spectroscopy of 2D semiconductors: a review](https://arxiv.org/abs/2512.04387)
*Yuri D. Glinka*
...
### [10] [Hole to Electron Crossover in a (Cd,Mn)Te Quantum Well through Surface Metallization](https://arxiv.org/abs/2512.04631)
...
### [11] [Exact and mean-field analysis of the role of Hubbard interactions on flux driven circular current in a quantum ring](https://arxiv.org/abs/2512.04736)
...
### [12] [Edge spin galvanic effect in altermagnets](https://arxiv.org/abs/2512.04798)
*L. E. Golub*
...
### [13] [Optical Readout of Reconfigurable Layered Magnetic Domain Structure in CrSBr](https://arxiv.org/abs/2512.04887)
...
### [14] [Suppressing metal molecule charge transfer with a phosphorus interlayer](https://arxiv.org/abs/2512.04999)
...
### [15] [Hall-like response from anisotropic Fermi surfaces](https://arxiv.org/abs/2512.05014)
*Abhiram Soori*
...
### [16] [High Fidelity Qubit Control in a Natural Si-MOS Quantum Dot using a 300 mm Silicon on Insulator Wafer](https://arxiv.org/abs/2512.05052)
...
### [17] [Axionic tunneling from a topological Kondo insulator](https://arxiv.org/abs/2512.05057)
...
### [18] [Multimode RF Reflectometry for Spin Qubit Readout and Device Characterization](https://arxiv.org/abs/2512.05087)
...
### [19] [Global phase diagram of two-dimensional dirty hyperbolic Dirac liquids](https://arxiv.org/abs/2512.05109)
...
### [20] [Double Perovskites K2NbTaO6 and Rb2NbTaO6 from First-Principles: Towards Efficient Materials for Green Energy](https://arxiv.org/abs/2512.04134)
...
### [21] [Characterizing Defect Dynamics in Silicon Carbide Using Symmetry-Adapted Collective Variables and Machine Learning Interatomic Potentials](https://arxiv.org/abs/2512.04242)
...
### [22] [More is different: How chemical complexity influences stability in high entropy oxides](https://arxiv.org/abs/2512.04290)
...
### [23] [Electrical Conductivity of Copper-Graphene (Cu-Gr) Composites: The Underlying Mechanisms of Ultrahigh Conductivity](https://arxiv.org/abs/2512.04304)
...
### [24] [Local expression of fractional corner charges in obstructed atomic insulators and its application to vertex-transitive polyhedra with arbitrary genus](https://arxiv.org/abs/2512.04325)
...
### [25] [Evidence of a two-dimensional nitrogen crystalline structure on silver surfaces](https://arxiv.org/abs/2512.04361)
...
### [26] [Preparation and magnetic properties of (Ln0.2La0.2Nd0.2Sm0.2 Eu0.2)MnO3 (Ln = Dy, Ho, Er) high-entropy perovskite ceramics containing heavy rare earth elements](https://arxiv.org/abs/2512.04370)
...
### [27] [General spin models from noncollinear spin density functional theory and spin-cluster expansion](https://arxiv.org/abs/2512.04458)
...
### [28] [Coulomb drag driven electron-hole bifluidity in doped graphene](https://arxiv.org/abs/2512.04602)
...
### [29] [Boosting the Memory Window of Memristive Stacks via Engineered Interfaces with High Ionic Mobility](https://arxiv.org/abs/2512.04706)
...
### [30] [Accelerating discovery of infrared nonlinear optical materials with large shift current via high-throughput screening](https://arxiv.org/abs/2512.04717)
...
### [31] [Heat transport in superionic materials via machine-learned molecular dynamics](https://arxiv.org/abs/2512.04718)
...
### [32] [Bulk photovoltaic effect in MoSe$_2$ and Janus MoSSe sliding ferroelectrics](https://arxiv.org/abs/2512.04760)
...
### [33] [Interfacial Synergy in Ag-Doped CuO-AgCl-g-C3N4 Composites for Efficient Charge Separation and Low-power Methylene Blue Degradation](https://arxiv.org/abs/2512.04825)
...
### [34] [Interband and kinetic corrections to the electronic Boltzmann transport equation](https://arxiv.org/abs/2512.04835)
...
### [35] [Isostructural phase transition and equation of state of type-I and type-VIII metallic sodium borosilicide clathrates](https://arxiv.org/abs/2512.04878)
...
### [36] [Valley Splittings in Si/SiGe Heterostructures from First Principles](https://arxiv.org/abs/2512.04879)
...
### [37] [Controlling Carbon Nanostructure Synthesis in Thermal Plasma Jet: Correlation of Process Parameters, Plasma Characteristics, and Product Morphology](https://arxiv.org/abs/2512.04880)
...
### [38] [In search of the electron-phonon contribution to total energy](https://arxiv.org/abs/2512.04897)
...
### [39] [Tuning the Electronic States of Bi2Se3 Films with Large Spin-Orbit Interaction Using Molecular Heterojunctions](https://arxiv.org/abs/2512.04922)
...
### [40] [A meta-GGA perspective on the altermagnetism of RuO2](https://arxiv.org/abs/2512.04995)
*Markus Meinert*
...
### [41] [Prediction of Novel Li-AgII-F Compounds using Evolutionary Algorithms](https://arxiv.org/abs/2512.05048)
