...
### [1] [Effect of substrate miscut angle on critical thickness, structural and electronic properties of MBE-grown NbN films on c-plane sapphire](https://arxiv.org/abs/2511.13917)
...
### [2] [Full Shapiro spectroscopy of current-phase relationships](https://arxiv.org/abs/2511.14313)
...
### [3] [Screw-dislocation-engineered quantum dot: geometry-tunable nonlinear optics, orbital qubit addressability, and torsion metrology](https://arxiv.org/abs/2511.13920)
*Edilberto O. Silva*
...
### [4] [Chemical vapor deposition growth of continuous monolayer antiferromagnetic CrOCl films](https://arxiv.org/abs/2511.14189)
...
### [5] [Shape dependence of Edelstein and magnetoelectric effects in the V-shaped model](https://arxiv.org/abs/2511.14404)
...
### [6] [Scaling of Low-Temperature Heat Capacity in Cryocrystals](https://arxiv.org/abs/2511.14409)
...
### [7] [Spintronics in antiferromagnetic helix: A new prescription](https://arxiv.org/abs/2511.14413)
...
### [8] [Observation of the surface hybridization gap in the electrical transport properties of the ultrathin topological insulator (Bi$_{1-x}$Sb$_{x}$)$_2$Te$_3$](https://arxiv.org/abs/2511.14454)
...
### [9] [Interplay of Electron Phonon Coupling Dissipative Phonon Bath and Electron Electron Interaction in a Triangular Quantum-Dot Trimer](https://arxiv.org/abs/2511.14641)
*Hemant Kumar Sharma*
...
### [10] [Hyperelastic stability landscape: A check for HILL stability of isotropic, incompressible hyperelasticity depending on material parameters](https://arxiv.org/abs/2511.13792)
*Herbert Baaser*
...
### [11] [Twin-boundary-induced nonrelativistic spin splitting](https://arxiv.org/abs/2511.14029)
...
### [12] [Integrating electronic structure into generative modeling of inorganic materials](https://arxiv.org/abs/2511.14228)
...
### [13] [Current-driven switching of topological spin chirality in a van der Waals antiferromagnet](https://arxiv.org/abs/2511.14241)
...
### [14] [Heat Capacity of Thermally Reduced Graphene Oxide: Compaction and Thermal Annealing Effects](https://arxiv.org/abs/2511.14253)
...
### [15] [Two-component anomalous Hall and Nernst effects in anisotropic Fe$_{4-x}$Ge$_x$N thin films](https://arxiv.org/abs/2511.14305)
...
### [16] [Composition-Dependent Properties of $\mathrm{Ce_{x}La_{0.95-x}Tb_{0.05}F_{3}}$ Nanopowders Tailored for X-Ray Photodynamic Therapy and Cathodoluminescence Imaging](https://arxiv.org/abs/2511.14500)
...
### [17] [Automated Prediction of Thermodynamic Properties via Bayesian Free-Energy Reconstruction from Molecular Dynamics](https://arxiv.org/abs/2511.14655)
