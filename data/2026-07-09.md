...
### [1] [BatteryMat: a hierarchical machine-learning and DFT framework for average-voltage screening of lithium-ion cathode materials](https://arxiv.org/abs/2607.06645)
...
### [2] [Origin of the reaction temperature in solid-state materials synthesis](https://arxiv.org/abs/2607.06685)
...
### [3] [Fluctuation-Driven Enhancement of Spin-Orbit Torque near the Curie Temperature of Ultrathin Ferromagnets](https://arxiv.org/abs/2607.06703)
...
### [4] [Physical exact conditions as regularizers for exchange-correlation in solids and surface chemistry](https://arxiv.org/abs/2607.06729)
*Johannes Voss*
...
### [6] [First-Principles Investigation of the Al-V Phase Diagram](https://arxiv.org/abs/2607.06741)
...
### [8] [Symmetry-Enforced Chiral Phonons in Altermagnets via Magnon-Phonon Coupling](https://arxiv.org/abs/2607.06792)
...
### [9] [Large-scale pseudopotential density functional theory calculations using orthogonalized enriched finite element basis](https://arxiv.org/abs/2607.06848)
...
### [13] [Non-Hermitian control of helicity-selective antiferromagnetic resonance](https://arxiv.org/abs/2607.07488)
...
### [14] [Surface-Reconstruction-Driven Insulating Behavior in Metallic Charge-Density-Wave 1T-TaSe$_{2}$](https://arxiv.org/abs/2607.06995)
...
### [15] [Size focusing in core-shell precipitates: A phase-field study](https://arxiv.org/abs/2607.07002)
...
### [16] [Minimizing propagated density errors of atomic core-electron for simultaneously accurate bandgaps and lattice constants in closed-shell Copper semiconductors](https://arxiv.org/abs/2607.07037)
...
### [17] [A modified Moss rule highlights underexplored classes of high refractive index materials](https://arxiv.org/abs/2607.07086)
...
### [18] [Phonon scattering mechanisms in WTe$_2$ observed by ultrafast coherent phonon spectroscopy](https://arxiv.org/abs/2607.07087)
...
### [19] [Ethaline deep eutectic solvent under nanoconfinement: Unveiling structural and dynamical changes](https://arxiv.org/abs/2607.07090)
...
### [20] [Unveiling Nanoscale Surface Damage Dynamics in Swift Heavy Ion Irradiated Gallium Nitride](https://arxiv.org/abs/2607.07092)
...
### [21] [Interplay of Umklapp scattering and Sb-Au hybridization in surface-reconstructed Sb/Au(111)](https://arxiv.org/abs/2607.07132)
...
### [22] [Terahertz Phase Inversion via Field-Free Spin-Orbit Torque Switching in an Antenna-Integrated Spintronic Heterostructure](https://arxiv.org/abs/2607.07220)
...
### [23] [Understanding surface potential dynamics of passivated perovskites via Kelvin Probe Force Microscopy](https://arxiv.org/abs/2607.07221)
...
### [24] [Improving feature resolution and pore back effect in focused ion beam tomography of porous GaN thin films](https://arxiv.org/abs/2607.07273)
...
### [25] [Bayesian Optimization of Genetic Algorithm Hyperparameters in a Multi-Fidelity Framework for Efficient Lattice Material Design](https://arxiv.org/abs/2607.07289)
...
### [26] [A Topotactic Phase Transition in the Uranium Oxide System](https://arxiv.org/abs/2607.07291)
...
### [27] [Electrical manipulation and detection of perpendicular altermagnetic order via proximitized Dirac semimetal](https://arxiv.org/abs/2607.07299)
...
### [28] [Machine Learning Materials Properties by Encoding Orbital-Projected Density of States](https://arxiv.org/abs/2607.07339)
...
### [29] [Optimizing high-temperature electron mobility in single-crystal Bi$_2$O$_2$Se based on its unconventional dependence on concentration](https://arxiv.org/abs/2607.07384)
...
### [30] [Growth of (111)-textured SrTiO3 thin films on Pt(111)/Al2O3(1-102) substrates by rf magnetron sputter deposition](https://arxiv.org/abs/2607.07428)
...
### [31] [A Multi-Scale Machine Learning Framework for Coupled Chemical, Spin, and Structural Disorder in Alloys](https://arxiv.org/abs/2607.07456)
...
### [32] [Stress calculation in linear scaling DFT: convergence and dynamics](https://arxiv.org/abs/2607.07472)
...
### [33] [Monolithic GaN Systems Combining Non-Volatile Memory and Analog Computing via Area-Ratio-Engineered Ferroelectric AlScN Gate Stacks](https://arxiv.org/abs/2607.07577)
...
### [34] [Human and LLM Collaboration for Accelerated Materials Synthesis and Discovery](https://arxiv.org/abs/2607.07604)
...
### [35] [MLIP Studio: An Open Platform for Interactive Benchmarking and Atomistic Simulations Using Machine Learning Interatomic Potentials](https://arxiv.org/abs/2607.07606)
...
### [36] [Acoustic-phonon-driven spin-lattice relaxation of the hBN boron vacancy in the sub-THz regime](https://arxiv.org/abs/2607.07642)
...
### [37] [Are Machine Learning Interatomic Potentials Truly Practical? A Benchmark of 23 Mainstream Models](https://arxiv.org/abs/2607.07647)
...
### [38] [Decoding magnetic texture](https://arxiv.org/abs/2607.07685)
...
### [39] [Moiré Phonon Condensation in Magic-Angle Twisted Bilayer Graphene](https://arxiv.org/abs/2607.06711)
...
### [40] [Mesoscopic routers and single-pole double-throw switches for electronic heat](https://arxiv.org/abs/2607.06716)
...
### [41] [Driven square lattice of quantum dots in a magnetic field coupled to a cylindrical FIR-photon cavity](https://arxiv.org/abs/2607.06812)
...
### [42] [High-frequency nonlinear conductivity of a Wigner crystal](https://arxiv.org/abs/2607.06846)
...
### [43] [Disorder signatures in coherent electronic waveguides](https://arxiv.org/abs/2607.06866)
...
### [44] [Scanning tunneling microscopy of resonant-impurity in altermagnets: dual Fano resonance and Landau-quantization-induced nodal spin contrast](https://arxiv.org/abs/2607.06885)
...
### [45] [Visualizing modified spin-wave wavefronts near magnetic defects and domains using nitrogen-vacancy centers](https://arxiv.org/abs/2607.06941)
...
### [46] [Perspectives on inverse design for AI magnonics](https://arxiv.org/abs/2607.07324)
...
### [47] [Spin-polarized electron transport for the altermagnet CrSb](https://arxiv.org/abs/2607.07334)
...
### [48] [Force-Isosurface Simulations Probe the Limits of High-Resolution AFM on Three-Dimensional Molecules](https://arxiv.org/abs/2607.07363)
...
### [49] [Nonlinear Dynamics of Hopfion for Frequency Multiplication](https://arxiv.org/abs/2607.07499)
...
### [50] [Tunnel-rate controlled local heat distribution in mesoscopic circuits](https://arxiv.org/abs/2607.07559)
...
### [51] [Unveiling the Spin-Valley Structure of Dipolar Exciton Ladders in R-stacked WSe$_2$/WS$_2$ Moiré Heterobilayers](https://arxiv.org/abs/2607.07590)
...
### [52] [Geometric Interpretation of Sum Photon Blockade](https://arxiv.org/abs/2607.07591)
...
### [53] [Non-Hermitian Edge State Endocytosis](https://arxiv.org/abs/2607.07703)
...
### [54] [Synthesis of Bulk Superconducting LiNbO$_2$ Crystals through CaH$_2$ Reduction](https://arxiv.org/abs/2607.06819)
...
### [55] [Emergent superconductivity upon disordering a topological insulator](https://arxiv.org/abs/2607.07163)
...
### [56] [Nucleation and Enhancement of Superconductivity under Tip-Induced Strain Fields](https://arxiv.org/abs/2607.07210)
...
### [57] [Pressure-induced Structural Phase Transition, Metallization, and Superconductivity in layered metalloid dichalcogenide 1T-SiTe$_2$](https://arxiv.org/abs/2607.07569)
