...
### [5] [Nonlocality-induced critical-length hierarchy from non-Hermitian competition](https://arxiv.org/abs/2608.02746)
...
### [6] [Broken site symmetry of Fe adatoms on Bi$_2$Te$_3$](https://arxiv.org/abs/2608.02770)
...
### [7] [Magneto-oscillations, nonlinearity, and nonreciprocity of Coulomb drag in quantum circuits](https://arxiv.org/abs/2608.02812)
...
### [8] [Lifshitz transitions and isospin polarization in twist-decoupled monolayer-bilayer graphene](https://arxiv.org/abs/2608.02899)
...
### [9] [Chaos and Diffusion in Twisted Bilayer Graphene](https://arxiv.org/abs/2608.02916)
...
### [10] [Hidden Quantum Geometry in Bilayer Exciton Condensates](https://arxiv.org/abs/2608.03049)
...
### [11] [Quaternion-Kahler geometry of time reversal symmetric crystals](https://arxiv.org/abs/2608.03178)
...
### [12] [Helicity in monoaxial chiral magnets](https://arxiv.org/abs/2608.03389)
...
### [13] [Surface-Selective Probe of Spin-Triplet Superconductivity in Rhombohedral Graphene](https://arxiv.org/abs/2608.03870)
...
### [14] [Vector-field control and emergent basal-plane anisotropy of magnetic textures in noncentrosymmetric (Fe$_{0.63}$Ni$_{0.3}$Pd$_{0.07}$)$_3$P](https://arxiv.org/abs/2608.03513)
...
### [15] [Enhancement of far-field thermal emission via polaritonic cavity modes](https://arxiv.org/abs/2608.03621)
...
### [16] [Machine Learning Bandgap Prediction of Nanoporous Graphenes with Water](https://arxiv.org/abs/2608.03680)
...
### [17] [Controllable interaction between photons and distant spins via vacuum Rabi oscillations](https://arxiv.org/abs/2608.03809)
...
### [18] [Wavelength-Selective control of Atomic Scale Au Contacts](https://arxiv.org/abs/2608.03831)
...
### [19] [Magnetic-field control of Fermi polaron fine structure and polarization in strained monolayer semiconductors](https://arxiv.org/abs/2608.03853)
*Zakhar A. Iakovlev*
...
### [20] [Investigation of GeSn aspect ratio trapping growth up to 8% Sn](https://arxiv.org/abs/2608.02710)
...
### [21] [Physics-Informed and Knowledge-Driven Generative AI for Autonomous Discovery of Porous Oxide Energy Materials: Opportunities and Challenges](https://arxiv.org/abs/2608.02858)
*Dibakar Datta*
...
### [22] [Symmetry-Guided Computational Screening of Two-Dimensional Altermagnets with ab initio Hubbard Corrections](https://arxiv.org/abs/2608.02925)
...
### [23] [Optical properties of Ag, Au, and Cu from first principles](https://arxiv.org/abs/2608.02968)
...
### [24] [Electrostatic Superlattices beyond 1:1 Stoichiometry](https://arxiv.org/abs/2608.02981)
...
### [25] [Apparent Dresselhaus coefficient in (001) GaAs quantum wells: Correlation-time renormalization in D'yakonov-Perel' spin relaxation](https://arxiv.org/abs/2608.03128)
...
### [26] [AccelNet: Exact backward-compatible acceleration of polynomial angular descriptors through Cartesian moment factorization](https://arxiv.org/abs/2608.03280)
*Yuki Nagai*
...
### [27] [Bias Tunable Transport Modulation and Gas Selectivity in Layered BiOI: A DFT NEGF Study](https://arxiv.org/abs/2608.03308)
...
### [28] [Picometre-scale real-time drift correction in TEM and STEM by dynamic control of the specimen stage for atomic-resolution imaging](https://arxiv.org/abs/2608.03344)
...
### [29] [Alloy engineering of excitonic properties in TMD monolayers](https://arxiv.org/abs/2608.03347)
...
### [30] [Magnetic and crystal electric field excitations in a spin-orbit coupled frustrated hyperkagome magnet Nd$_3$Li$_3$W$_2$O$_{12}$](https://arxiv.org/abs/2608.03365)
...
### [31] [Anisotropic Phonon Heat Flow and Thermoelectric Response in Tetragonal GeS$_2$ and GeSe$_2$](https://arxiv.org/abs/2608.03478)
...
### [32] [Spin-Chirality-Driven Bulk Photovoltaic Effect in van der Waals Magnet CrSBr](https://arxiv.org/abs/2608.03492)
...
### [33] [Strain Tuning of Orbital-Driven Giant Magnetoresistance in van der Waals ferrimagnet Mn$_3$Si$_2$Te$_6$](https://arxiv.org/abs/2608.03568)
...
### [34] [The New High-entropy Compound RhMnFeCoGe4 with Cubic Non-centrosymmetric B20 Structure](https://arxiv.org/abs/2608.03523)
...
### [35] [Toward two dimensional MoS2 electrets](https://arxiv.org/abs/2608.03602)
...
### [36] [Epitaxial SiGeSn alloys for CMOS-compatible thermoelectric devices](https://arxiv.org/abs/2608.03638)
...
### [37] [Machine Learning-Guided Screening of Advantageous Solvents for Solid Polymer Electrolytes in Lithium Metal Batteries](https://arxiv.org/abs/2608.03688)
...
### [38] [Guided Synthesis of EMT Zeolites by Machine Learning](https://arxiv.org/abs/2608.03760)
...
### [39] [From phase transformation to amorphization: damage accumulation in Yb-implanted \b{eta}-Ga2O3](https://arxiv.org/abs/2608.03798)
...
### [40] [Physics-Informed Machine Learning for Refractory Alloy Design](https://arxiv.org/abs/2608.03805)
...
### [41] [Generalized Space Groups from Internal Configuration Spaces](https://arxiv.org/abs/2608.03808)
...
### [42] [Optical centers in cubic boron nitride and diamond: remarkable similarities](https://arxiv.org/abs/2608.03901)
...
### [43] [Phonon-based determination of elastic coefficients in the Weyl semimetal TaAs](https://arxiv.org/abs/2608.03903)
...
### [44] [Understanding and Designing Phase Change Materials: Insights from Atom Probe Tomography](https://arxiv.org/abs/2608.03932)
...
### [45] [Emergence of Chiral Helimagnetic Order in Chromium-intercalated Tantalum Disulfide CrTa$_3$S$_6$ Powders with Controlled Intercalation](https://arxiv.org/abs/2608.03953)
