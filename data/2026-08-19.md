...
### [5] [Flat band and Bulk-Boundary correspondence in a non-Hermitian trimerized lattice model with generic boundary conditions](https://arxiv.org/abs/2608.17428)
...
### [6] [Robust stabilization of high-frequency magnetic droplets in W-CoFeB-MgO nanoconstriction spin Hall nano-oscillators](https://arxiv.org/abs/2608.17677)
...
### [16] [PowderLine: a programmatic powder diffraction analysis application](https://arxiv.org/abs/2608.17009)
...
### [17] [Over what length scale does an inorganic substrate perturb the structure of a glassy organic semiconductor?](https://arxiv.org/abs/2608.17089)
...
### [18] [Temperature-Induced Reorganization of Supported Zn$_3$ Clusters on Cu(111): From Minimum-Energy Structures to Finite-Temperature Ensembles](https://arxiv.org/abs/2608.17149)
...
### [19] [Discovery of novel magnetic Y-Mn-B compounds via advanced machine learning guided framework](https://arxiv.org/abs/2608.17200)
...
### [20] [Windmill Spin Dynamics and Its Induced Anomalous Hall Effect in Noncollinear Antiferromagnet Mn3Sn](https://arxiv.org/abs/2608.17225)
...
### [21] [Fresnel diffraction imaging of surface nanostructure using coherent resonant X-ray scattering](https://arxiv.org/abs/2608.17377)
...
### [22] [Giant Bandgap Pulsation Driven by Hotspot Breathing Phonons in a Flat-Band Solid](https://arxiv.org/abs/2608.17408)
...
### [23] [Intra-atomic magnetic octupoles and their coupling to cluster magnetic octupoles in Chiral antiferromagnets Mn$_3$Sn](https://arxiv.org/abs/2608.17461)
...
### [24] [Growth of Altermagnetic α-MnTe Films: Substrate Variation and Surface Modification](https://arxiv.org/abs/2608.17513)
...
### [25] [Multiple topological electronic and phononic quasiparticle excitations in hexagonal TTe (T=Hf, Zr & Ti) crystals](https://arxiv.org/abs/2608.17557)
...
### [26] [Chiral Spinterfaces as an Overlooked Component of the Chiral-Induced Spin Selectivity Effect](https://arxiv.org/abs/2608.17608)
...
### [27] [Quantized Spin Hall Effect in Three-Dimensional Nodal-Ring Semimetal: Geometric Scaling and Symmetry-Engineered Spin Response](https://arxiv.org/abs/2608.17627)
...
### [28] [Atomistic Structure Generation and Neural-Network Screening of Hard Carbons to Identify High-Capacity Sodium Storage](https://arxiv.org/abs/2608.17716)
...
### [29] [Vacancy-Driven Electronic Reconstruction in Monolayer PtSe$_2$: Formation Thermodynamics and Charge States](https://arxiv.org/abs/2608.17720)
...
### [30] [Active learning molecular beam epitaxy of complex quantum materials](https://arxiv.org/abs/2608.17742)
...
### [31] [Polarization-Dependent Raman Selection Rules in Sb$_2$S$_3$ from First Principles and Experiment](https://arxiv.org/abs/2608.17786)
...
### [32] [Defect Geometry Selects Polar and Anomalous Hall Phases in Two-Dimensional Altermagnets](https://arxiv.org/abs/2608.17788)
...
### [33] [Electron transport in amorphous materials: from localization to predictive transport modeling](https://arxiv.org/abs/2608.17814)
*Yeonghun Lee*
...
### [34] [Optical decoherence in Er$^{3+}$-doped CeO$_2$ spin qubit platforms](https://arxiv.org/abs/2608.17867)
...
### [35] [Energy-efficient, Reconfigurable Optoelectronic Artificial Synapses Based on MoWS$_2$ Alloy for Pattern Recognition and Color Image Filtering Applications](https://arxiv.org/abs/2608.18013)
