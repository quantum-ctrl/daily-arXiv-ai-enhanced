...
### [1] [Higher-order topological superconductivity in type-II time-reversal-symmetric Weyl semimetals with a hybrid pairing](https://arxiv.org/abs/2511.08973)
...
### [2] [Stability, electronic disruption, and anisotropic superconductivity of hydrogenated trilayer metal tetraborides (MB$_{4}$H; M=Be, Mg, Ca, Al)](https://arxiv.org/abs/2511.09009)
...
### [3] [First-principles evidence for conventional superconductivity in a quasicrystal approximant](https://arxiv.org/abs/2511.09224)
...
### [4] [The parent state in kagome metals and superconductors: Chiral-nematic Fermi liquid state](https://arxiv.org/abs/2511.09402)
...
### [5] [Impact of Electron Correlations on Infinite-Layer Cuprates and Nickelates](https://arxiv.org/abs/2511.09460)
...
### [6] [Polaron and Strain Effects on Ion Migration in WO$_3$](https://arxiv.org/abs/2511.08718)
...
### [7] [Decoupling Composition and Band Gap in $κ$-Ga$_2$O$_3$ Heterostructures via STEM-EELS](https://arxiv.org/abs/2511.08728)
...
### [8] [Average density of Bloch electrons in a homogeneous magnetic field: a second-order response](https://arxiv.org/abs/2511.08761)
*Benjamin M. Fregoso*
...
### [9] [TEM Agent: enhancing transmission electron microscopy (TEM) with modern AI tools](https://arxiv.org/abs/2511.08819)
...
### [10] [AC magnetometry of van der Waals magnets using ultrasensitive Graphene Hall sensors](https://arxiv.org/abs/2511.08962)
...
### [11] [Mobile chemical cage: Revealing the origin of anomalous lithium diffusion in liquid $Li_{17}Pb_{83}$ alloy](https://arxiv.org/abs/2511.08890)
...
### [12] [A scalable kinetic Monte Carlo platform enabling comprehensive simulations of charge transport dynamics in polymer-based memristive systems](https://arxiv.org/abs/2511.09413)
...
### [13] [Quasi-linear magnetoresistance and paramagnetic singularity in Hypervalent Bismuthide](https://arxiv.org/abs/2511.08911)
...
### [14] [First-Principles Investigation of Surface-Induced Effects on the Properties of Divacancy Qubits in 3C-SiC](https://arxiv.org/abs/2511.09436)
...
### [15] [MicroEvoEval: A Systematic Evaluation Framework for Image-Based Microstructure Evolution Prediction](https://arxiv.org/abs/2511.08955)
...
### [16] [High-speed, High-Resolution, Three-Dimensional Imaging of Threading Dislocations in beta-$Ga_{2}O_{3}$ via Phase-Contrast Microscopy](https://arxiv.org/abs/2511.08981)
...
### [17] [High-throughput, Non-Destructive, Three-Dimensional Imaging of GaN Threading Dislocations with in-Plane Burgers Vector Component via Phase-Contrast Microscopy](https://arxiv.org/abs/2511.08989)
...
### [18] [Discovery of a new magnesium iron boride Mg4Fe1.1B13.9 in the Mg-Fe-B-N system](https://arxiv.org/abs/2511.09128)
*N. D. Zhigadlo*
...
### [19] [Enhanced spectral range of strain-induced tuning of quantum dots in circular Bragg grating cavities](https://arxiv.org/abs/2511.09155)
...
### [20] [Assessing Band Gap Stability of Organic Semiconductor Thin Films for Flexible Electronic Applications](https://arxiv.org/abs/2511.09226)
...
### [21] [Phase transformations in metastable $β$ Zr15Nb alloy revealed by in-situ methods](https://arxiv.org/abs/2511.09236)
...
### [22] [Hydrogen permeability prediction in palladium alloys and virtual screening of B2-phase stabilized Pd(100-x-y)CuxMy ternary alloys using machine learning](https://arxiv.org/abs/2511.09245)
...
### [23] [Tunable laser-generated GHz surface acoustic waves during magnetostructural phase transition in FeRh thin films](https://arxiv.org/abs/2511.09318)
...
### [24] [Low-Temperature Heat Capacity and Phonon Dynamics in Expanded Graphite and EG--MWCNTs Composites](https://arxiv.org/abs/2511.09338)
...
### [25] [High-quality nanostructured diamond membranes for nanoscale quantum sensing](https://arxiv.org/abs/2511.08632)
...
### [26] [Dephasing-induced Quantum Hall Criticality in the Quantum Anomalous Hall system](https://arxiv.org/abs/2511.08635)
*Fei Yang,Dong E. Liu*
...
### [27] [Mechanical and electrical properties of a nano-gap or how to play the nano-accordion](https://arxiv.org/abs/2511.08727)
...
### [28] [Dynamical Orbital Angular Momentum Induced by Chiral Phonons](https://arxiv.org/abs/2511.09271)
...
### [29] [Interface tuned Enhanced and Low Temperature Quenching of Orbital Hall Currents Induce Torque and magnetoresistance in Light Metal/Nickel Bilayers](https://arxiv.org/abs/2511.09349)
...
### [30] [Spin and orbital-to-charge conversion in noncentrosymmetric materials: Hall versus Rashba-Edelstein effects](https://arxiv.org/abs/2511.09511)
