...
### [1] [Quantum Hall Liquids Coupled to Dynamical Electromagnetism](https://arxiv.org/abs/2604.26014)
...
### [2] [Magnetononlinear Hall effect from multigap topology in metal-organic frameworks](https://arxiv.org/abs/2604.26028)
...
### [3] [Strain and Twist Engineering of Interfacial Thermal Transport in Homo- and Hetero-Interfaces of Graphene and Hexagonal Boron Nitride](https://arxiv.org/abs/2604.26300)
...
### [4] [Voltage-Regulated Photoluminescence Modulation in a 0D-2D Mixed Dimensional Heterostructure](https://arxiv.org/abs/2604.26358)
...
### [5] [Influence of a graphene substrate on the stabilization of molecular systems with hydrogen bonds](https://arxiv.org/abs/2604.26510)
*Alexander V. Savin*
...
### [6] [Flux-Mediated Correspondence Between Real- and Momentum-Space Nonsymmorphicity](https://arxiv.org/abs/2604.26575)
*Z. Y. Chen,Y. X. Zhao*
...
### [7] [Tunable high-Chern-number Chern insulators in rhombohedral tetralayer graphene/hBN moiré superlattices](https://arxiv.org/abs/2604.26643)
...
### [8] [Beyond conventional skyrmions in synthetic antiferromagnets](https://arxiv.org/abs/2604.26680)
...
### [9] [Metalization of topological insulators](https://arxiv.org/abs/2604.26698)
...
### [10] [Non-Equilibrium Orbital Transport in Terahertz Optorbitronics](https://arxiv.org/abs/2604.26717)
...
### [11] [Sub-50 Picosecond exceptionally Bright Perovskite Scintillation by Unlocking Giant Oscillator Strength](https://arxiv.org/abs/2604.26751)
...
### [12] [Transport characteristics of bulk and edge states in an off-diagonal Aubry--André--Harper chain](https://arxiv.org/abs/2604.26800)
*Moumita Patra*
...
### [13] [Large quantum dot energy level shifts in anomalous photon-assisted tunneling](https://arxiv.org/abs/2604.26947)
...
### [14] [Exposing impostor Majorana zero modes through atomic-scale shot-noise](https://arxiv.org/abs/2604.26002)
...
### [15] [From Wavefunction Collapse to Superconductivity: Evolution of the Electronic State in Compressed GaNb4Se8](https://arxiv.org/abs/2604.26203)
...
### [16] [Programmable superconducting diode from nematic domain control in FeS](https://arxiv.org/abs/2604.26631)
...
### [17] [Negative nonlocal and local voltages (resistances) in a quasi-one-dimensional superconducting aluminum structure](https://arxiv.org/abs/2604.26814)
...
### [18] [Engineering superconductivity on the surface of Weyl semimetals](https://arxiv.org/abs/2604.26859)
...
### [19] [Non-local Tunneling Spectroscopy of Inelastic Quasiparticle Relaxation in Superconducting 1-D Wires](https://arxiv.org/abs/2604.26862)
...
### [20] [Domain-induced control of latent heat in freestanding BaTiO$_3$ membranes](https://arxiv.org/abs/2604.26089)
...
### [21] [Hidden Crossover and Relaxor-Like Response from Emerging Polar Skyrmion Correlations in Ferroelectric Superlattices](https://arxiv.org/abs/2604.26100)
...
### [22] [Implementation of the hybrid exchange-correlation functionals in the SIESTA code](https://arxiv.org/abs/2604.26108)
...
### [23] [First-Principles Study of Structural, Electronic, Thermal, and Optical Properties of Quasi-2D C2 N2 O Using GGA and HSE06](https://arxiv.org/abs/2604.26149)
...
### [24] [Achieving Large Uniaxial and Homogeneous Strain in Two-Dimensional Materials](https://arxiv.org/abs/2604.26164)
...
### [25] [Negative magnetoresistance in strained $α$-Sn and $α$-SnGe films in an in-plane magnetic field](https://arxiv.org/abs/2604.26168)
...
### [26] [All-organic self-separating three-dimensionally nanoarchitected electrochemical energy storage devices](https://arxiv.org/abs/2604.26222)
...
### [27] [Coexistence of d-Wave Altermagnetism and Topological States in Janus FeSeX (X = S, Te) Monolayers](https://arxiv.org/abs/2604.26239)
...
### [28] [Influence of strain on the anomalous Hall and Nernst effects in Fe thin films](https://arxiv.org/abs/2604.26257)
...
### [29] [Accelerated Prediction of Surface Stability and Particle Morphology in Ionic Crystals via Electrostatic Screening](https://arxiv.org/abs/2604.26264)
...
### [30] [Molecular Dynamics simulations of Al-Ti metallic alloy melts using a transferable machine-learning potential](https://arxiv.org/abs/2604.26362)
...
### [31] [Polaron Conductivity in $α$-Fe2O3 Quenched by Adsorbed NO2](https://arxiv.org/abs/2604.26372)
...
### [32] [A Theoretical Investigation of the Thermal and Photochemical Mechanisms of Ethylbenzene Dehydrogenation on Rutile TiO$_{2}$(110)](https://arxiv.org/abs/2604.26428)
*Nico Yannik Merkt*
...
### [33] [Geometry-Based Neural-Network Prediction of Electron Localization Function Topology in Dense Hydrogen](https://arxiv.org/abs/2604.26445)
...
### [34] [Anomalous, pre-yield grain-boundary sliding in copper revealed with in-situ high-resolution strain mapping](https://arxiv.org/abs/2604.26515)
...
### [35] [aim2dat: A Python infrastructure for automated ab initio material modeling and data analysis](https://arxiv.org/abs/2604.26551)
...
### [36] [Unraveling the symmetry of Al5C3N](https://arxiv.org/abs/2604.26560)
...
### [37] [Revealing magnetism in the distorted kagome $R$Ti$_3$Bi$_4$ ($R$ = Nd, Sm, Gd) via ARPES and XMCD](https://arxiv.org/abs/2604.26636)
...
### [38] [Third-order intrinsic anomalous Hall effect as a transport fingerprint of altermagnets](https://arxiv.org/abs/2604.26665)
...
### [39] [Emergent surface resonance from charge density wave symmetry breaking in TiSe2](https://arxiv.org/abs/2604.26685)
...
### [40] [Predicting massive helium-3 release from metal tritides using simple mechanical modeling](https://arxiv.org/abs/2604.26697)
...
### [41] [A self-evolving agent for explainable diagnosis of DFT-experiment band-gap mismatch](https://arxiv.org/abs/2604.26703)
*Yue Li,Bijun Tang*
...
### [42] [Tracking visible pulsed laser annealing of Hf0.5Zr0.5O2 heterostructures with in situ transmission electron microscopy](https://arxiv.org/abs/2604.26718)
...
### [43] [Resolving growth-induced off-stoichiometry in AgCrSe$_2$ single crystals](https://arxiv.org/abs/2604.26887)
