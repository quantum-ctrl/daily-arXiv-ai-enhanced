...
### [19] [Tunable Magnetic Frustration in the Cu-Ru-based Double Perovskite La$_{2-x}$Sm$_x$CuRuO$_6$ (x = 0, 1, 2) Oxides](https://arxiv.org/abs/2608.23741)
...
### [20] [Can Strain or Anion Interchange Make an Unstable Structure Stable? Energetics, Lattice Dynamics and Strain-Tunable Band Gaps of Lithium Chalcohalide Antiperovskites (Li$_{3}$$BA$) and their Anion Interchange Variants (Li$_{3}$$AB$)](https://arxiv.org/abs/2608.23815)
...
### [21] [Spectrally Programmable Spin-Polarized Photocurrents in WSe$_2$-NiPS$_3$ Magnetic van der Waals Heterostructures](https://arxiv.org/abs/2608.23832)
...
### [22] [Engineering Dirac interface states](https://arxiv.org/abs/2608.24006)
...
### [23] [Bonding Signatures of Incipient Electron Localization in Topological Chiral Semimetals Near the Metal-Insulator Transition](https://arxiv.org/abs/2608.24139)
...
### [24] [Classification of Metal - Insulator Transitions: Relating characteristic Properties to Quantum Chemical Bonding Descriptors](https://arxiv.org/abs/2608.24149)
...
### [25] [Depth-Resolved Evolution of Buried Polar Topologies in a PbTiO3/SrTiO3 Superlattice](https://arxiv.org/abs/2608.24182)
...
### [26] [Excitonic fingerprints of magnetic configurations and switching in multilayer CrSBr](https://arxiv.org/abs/2608.24216)
...
### [27] [Two Microscopic Mechanisms of Piezomagnetism in CoF$_2$ from First-Principles Calculations](https://arxiv.org/abs/2608.24227)
...
### [28] [Influence of Interface Energy Anisotropy on the Solid-state Instability in Ni-based Superalloy: A Multiscale Study](https://arxiv.org/abs/2608.24234)
...
### [29] [Off-stoichiometric variable doping for exceptional power factors in L2$_1$ Fe$_2$VAlM$_x$ (M=Ti, W) epitaxial thin films](https://arxiv.org/abs/2608.24236)
...
### [30] [A hidden low-temperature transformation pathway in compositionally complex materials](https://arxiv.org/abs/2608.24357)
...
### [31] [A colossal dielectric response of Bi1-xSmxFeO3 nanopowders](https://arxiv.org/abs/2608.24420)
...
### [32] [Plastic Relaxation without Dislocations in $β$-Ga$_2$O$_3$ Heteroepitaxy: A Structural Peculiarity of Ga$_2$O$_3$ Polymorphs](https://arxiv.org/abs/2608.24465)
...
### [33] [Structure-Agnostic Prediction of the Electronic Density of States with a Chemical Language Model](https://arxiv.org/abs/2608.24513)
...
### [34] [Interface-Controlled Defect Engineering in TiN/TaN Superlattices for Enhanced Hardness and Fracture Toughness](https://arxiv.org/abs/2608.24607)
...
### [35] [Thermal diffuse scattering in TEM: complex absorptive potentials compared to the frozen phonon model](https://arxiv.org/abs/2608.24679)
...
### [36] [Multiscale Modelling of Ferroelectrics using a Physics-Informed Neural Network Driven by Molecular Dynamics Data: Parameter Identification and Field Reconstruction](https://arxiv.org/abs/2608.24733)
...
### [37] [AlV$_2$O$_4$ thin films via in-situ interfacial topotaxy](https://arxiv.org/abs/2608.24821)
...
### [38] [Predicting THz Generation Capability of Organic Crystals through Data Mining and Crystal Nonlinearity Models](https://arxiv.org/abs/2608.24835)
