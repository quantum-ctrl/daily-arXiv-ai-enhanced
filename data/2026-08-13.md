...
### [7] [Large bias-tunable magnetoresistance from spin-dependent interlayer hybridization in van der Waals antiferromagnet CrSBr-based heterostructures](https://arxiv.org/abs/2608.11389)
...
### [8] [Layer-Number-Controlled Symmetry Breaking and Surface-State Transport in Rhombohedral Graphene Multilayers](https://arxiv.org/abs/2608.11450)
...
### [9] [Dynamics of the spontaneous emission factor in multiple quantum well nanowire lasers](https://arxiv.org/abs/2608.11523)
...
### [10] [Spatially Resolving the Pre-Thermal Anatomy of a Driven Bosonic Fluid](https://arxiv.org/abs/2608.11561)
...
### [11] [Realization of Arbitrary Gauge Fields via Symmetry-Protected Zero Modes](https://arxiv.org/abs/2608.11609)
...
### [12] [Spin lifetime anisotropy in graphene induced by the SiO2 interface](https://arxiv.org/abs/2608.11615)
...
### [13] [Magnetic noise of a dark exciton Bose-Einstein condensate](https://arxiv.org/abs/2608.11740)
*Pieter M. Gunnink*
...
### [14] [Quantum Anomalous Hall Effect in $d^{10}$ Oxide Monolayers](https://arxiv.org/abs/2608.11855)
...
### [15] [Dimensional crossover and local strain induced deflection of the spin spiral state in multiferroic NiI2](https://arxiv.org/abs/2608.11944)
...
### [16] [Mismatch between Raman shear modes and ferroelectric polarization in 3R-MoS$_{2}$](https://arxiv.org/abs/2608.11988)
...
### [17] [Lectures on ultrathin film ferromagnetism](https://arxiv.org/abs/2608.12189)
*D. Pescia*
...
### [18] [Electron transport in a 1.6~nm-thick double-gated (100) silicon nanosheet: A theoretical study accounting for phonon confinement and remote-phonon scattering](https://arxiv.org/abs/2608.12214)
...
### [19] [Second-Chern Bounds in Non-Abelian Quantum Geometry](https://arxiv.org/abs/2608.12221)
...
### [20] [Exact solution for stationary states of a closed memristor with mobile charged vacancies](https://arxiv.org/abs/2608.12264)
...
### [21] [Wormhole Geometry from a Magnetic Vortex](https://arxiv.org/abs/2608.12285)
...
### [22] [Temperature-Driven Sequential Modeling for the Prediction of Annual Power Conversion Efficiency Profiles of Organic Photovoltaic Materials: Douala Case Study](https://arxiv.org/abs/2608.11261)
...
### [23] [Chemically Meaningful Textualization Enables Explainable Validation of Metal-Organic Frameworks by Large Language Models](https://arxiv.org/abs/2608.11283)
...
### [24] [Strain-controlled magnetism and magnetoelasticity in monolayer NiPS$_3$ and CrPS$_4$](https://arxiv.org/abs/2608.11356)
...
### [25] [Many-Body Destabilization of Intermediate Oxygen-Hole States](https://arxiv.org/abs/2608.11388)
...
### [26] [Symmetry-Dependent Mechanical and Vibrational Response of Formamidinium Lead Halide Perovskites: A DFT Study](https://arxiv.org/abs/2608.11411)
...
### [27] [Accurate Evaluation of Nanoscale Spatiotemporal Dynamics with Electron Correlation Microscopy](https://arxiv.org/abs/2608.11466)
...
### [28] [Soft-Phonon-Driven Effective Inversion-Symmetry Crossover in Quantum Paraelectrics](https://arxiv.org/abs/2608.11471)
...
### [29] [Advances and opportunities for automated robotic preparation of 2D materials and fabrication of 2D heterostructures](https://arxiv.org/abs/2608.11485)
...
### [30] [Magnetoelastic coupling descriptor for high-throughput ab initio search of magnetocaloric materials](https://arxiv.org/abs/2608.11589)
...
### [31] [First-principles cumulant approach to the vibronic structure of spin defects](https://arxiv.org/abs/2608.11687)
...
### [32] [Deep-Learning-Accelerated Dopant Selection for High-k HfO2 Dielectrics: A Disorder-Resolved Study of Y, Si and Al](https://arxiv.org/abs/2608.11725)
...
### [33] [Advancing in situ hydrogen embrittlement studies through an integrated charging cell for SEM micromechanical testing](https://arxiv.org/abs/2608.11773)
...
### [34] [Lithography-free patterning of SrTiO$_3$-based two-dimensional electron gases using direct atomic layer processing](https://arxiv.org/abs/2608.11809)
...
### [35] [Data-Efficient Adaptation of DPA-4 Force Fields to DFT+U Energetics: A Case Study in NiO](https://arxiv.org/abs/2608.11812)
...
### [36] [Optically Tunable Threshold Switching and Thermally Activated Transport in Planar Ag/MAPbI$_3$ Thin Single-Crystal Devices](https://arxiv.org/abs/2608.11832)
...
### [37] [Strain-controlled sign reversal of the anomalous Hall effect in Ru/[Co/Ni]$_N$ multilayers](https://arxiv.org/abs/2608.11897)
...
### [38] [Beam Routing through Excitons in Transition Metal Dichalcogenide Monolayers](https://arxiv.org/abs/2608.12105)
...
### [39] [Magneto-optical magnetoelectric voltage sensor](https://arxiv.org/abs/2608.11910)
...
### [40] [The electrical transport of intrinsic two-dimensional ferroelectric metal PtBi2](https://arxiv.org/abs/2608.12152)
...
### [41] [Resonant Raman signatures of bright and momentum-dark exciton coupled by intervalley phonon scattering in monolayer WSe2](https://arxiv.org/abs/2608.11914)
...
### [42] [Electronic structure, band offset, and interface electron population of the LaInO$_3$/BaSnO$_3$ system](https://arxiv.org/abs/2608.11952)
...
### [43] [Energy-Dependent Dechanneling in Cu: Insights from Monte Carlo Channeling Simulations](https://arxiv.org/abs/2608.12017)
...
### [44] [Thermoelastic Harvesting Outperforming Thermoelectric Generators Below 100 °C](https://arxiv.org/abs/2608.12092)
...
### [45] [PACE-SIMS: Checkpoint-Gated Autonomous SIMS Characterization with AI-Agent Quality Control](https://arxiv.org/abs/2608.12277)
